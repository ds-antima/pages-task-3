...
function UnwrappedGoogleMaps({
  ...
  function Infowindow(i: number, result: any): void {
    ...
    let url1:any = country+"/"+finalregion+"/"+finalcity+"/"+result.rawData.slug+".html";
    ...
    const MarkerContent = (
      <>
        ...
        alt="" /></div> */}
            <h2>
              <a className="inline-block notHighlight" href={`${url1}`}>
                {result.rawData.name}
              </a>
            </h2>
          </div>
    ...
    <div className="icon-row">
      ...
      <div className="content-col">
        ...
        <div className="button-bx !ml-4 !mb-0">
          <a type="button" href={`${url1}`} className="btn">
